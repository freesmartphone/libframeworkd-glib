...

{
  ...
  return dbus_g_proxy_begin_call (proxy, "GetAuthStatus", org_freesmartphone_GSM_SIM_get_auth_status_async_callback, stuff, _dbus_glib_async_data_free, G_TYPE_INVALID);
}
static
#ifdef G_HAVE_INLINE
inline
...

{
  ...
  stuff->cb = G_CALLBACK (callback);
  stuff->userdata = userdata;
  return dbus_g_proxy_begin_call (proxy, "SendAuthCode", org_freesmartphone_GSM_SIM_send_auth_code_async_callback, stuff, _dbus_glib_async_data_free, G_TYPE_STRING, IN_pin, G_TYPE_INVALID);
}
static
#ifdef G_HAVE_INLINE
inline
...

{
  ...
  stuff->cb = G_CALLBACK (callback);
  stuff->userdata = userdata;
  return dbus_g_proxy_begin_call (proxy, "Unlock", org_freesmartphone_GSM_SIM_unlock_async_callback, stuff, _dbus_glib_async_data_free, G_TYPE_STRING, IN_puk, G_TYPE_STRING, IN_new_pin, G_TYPE_INVALID);
}
static
#ifdef G_HAVE_INLINE
inline
...

{
  ...
  stuff->cb = G_CALLBACK (callback);
  stuff->userdata = userdata;
  return dbus_g_proxy_begin_call (proxy, "ChangeAuthCode", org_freesmartphone_GSM_SIM_change_auth_code_async_callback, stuff, _dbus_glib_async_data_free, G_TYPE_STRING, IN_old_pin, G_TYPE_STRING, IN_new_pin, G_TYPE_INVALID);
}
static
#ifdef G_HAVE_INLINE
inline
...

{
  ...
  stuff->cb = G_CALLBACK (callback);
  stuff->userdata = userdata;
  return dbus_g_proxy_begin_call (proxy, "SetAuthCodeRequired", org_freesmartphone_GSM_SIM_set_auth_code_required_async_callback, stuff, _dbus_glib_async_data_free, G_TYPE_BOOLEAN, IN_check, G_TYPE_STRING, IN_pin, G_TYPE_INVALID);
}
static
#ifdef G_HAVE_INLINE
inline
...

{
  ...
  stuff->cb = G_CALLBACK (callback);
  stuff->userdata = userdata;
  return dbus_g_proxy_begin_call (proxy, "GetAuthCodeRequired", org_freesmartphone_GSM_SIM_get_auth_code_required_async_callback, stuff, _dbus_glib_async_data_free, G_TYPE_INVALID);
}
static
#ifdef G_HAVE_INLINE
inline
...

{
  ...
  stuff->cb = G_CALLBACK (callback);
  stuff->userdata = userdata;
  return dbus_g_proxy_begin_call (proxy, "GetSimInfo", org_freesmartphone_GSM_SIM_get_sim_info_async_callback, stuff, _dbus_glib_async_data_free, G_TYPE_INVALID);
}
static
#ifdef G_HAVE_INLINE
inline
...

{
  ...
  stuff->cb = G_CALLBACK (callback);
  stuff->userdata = userdata;
  return dbus_g_proxy_begin_call (proxy, "SendGenericSimCommand", org_freesmartphone_GSM_SIM_send_generic_sim_command_async_callback, stuff, _dbus_glib_async_data_free, G_TYPE_STRING, IN_command, G_TYPE_INVALID);
}
static
#ifdef G_HAVE_INLINE
inline
...

{
  ...
  stuff->cb = G_CALLBACK (callback);
  stuff->userdata = userdata;
  return dbus_g_proxy_begin_call (proxy, "SendRestrictedSimCommand", org_freesmartphone_GSM_SIM_send_restricted_sim_command_async_callback, stuff, _dbus_glib_async_data_free, G_TYPE_INT, IN_command, G_TYPE_INT, IN_fileid, G_TYPE_INT, IN_p1, G_TYPE_INT, IN_p2, G_TYPE_INT, IN_p3, G_TYPE_STRING, IN_data, G_TYPE_INVALID);
}
static
#ifdef G_HAVE_INLINE
inline
...

{
  ...
  stuff->cb = G_CALLBACK (callback);
  stuff->userdata = userdata;
  return dbus_g_proxy_begin_call (proxy, "GetHomeZones", org_freesmartphone_GSM_SIM_get_home_zones_async_callback, stuff, _dbus_glib_async_data_free, G_TYPE_INVALID);
}
static
#ifdef G_HAVE_INLINE
inline
#endif
gboolean
org_freesmartphone_GSM_SIM_list_phonebooks (DBusGProxy *proxy, char *** OUT_categories, GError **error)

{
  return dbus_g_proxy_call (proxy, "ListPhonebooks", error, G_TYPE_INVALID, G_TYPE_STRV, OUT_categories, G_TYPE_INVALID);
}

typedef void (*org_freesmartphone_GSM_SIM_list_phonebooks_reply) (DBusGProxy *proxy, char * *OUT_categories, GError *error, gpointer userdata);

static void
org_freesmartphone_GSM_SIM_list_phonebooks_async_callback (DBusGProxy *proxy, DBusGProxyCall *call, void *user_data)
{
  DBusGAsyncData *data = (DBusGAsyncData*) user_data;
  GError *error = NULL;
  char ** OUT_categories;
  dbus_g_proxy_end_call (proxy, call, &error, G_TYPE_STRV, &OUT_categories, G_TYPE_INVALID);
  (*(org_freesmartphone_GSM_SIM_list_phonebooks_reply)data->cb) (proxy, OUT_categories, error, data->userdata);
  return;
}
...
#endif
DBusGProxyCall*
org_freesmartphone_GSM_SIM_list_phonebooks_async (DBusGProxy *proxy, org_freesmartphone_GSM_SIM_list_phonebooks_reply callback, gpointer userdata)

{
  ...
  stuff->cb = G_CALLBACK (callback);
  stuff->userdata = userdata;
  return dbus_g_proxy_begin_call (proxy, "ListPhonebooks", org_freesmartphone_GSM_SIM_list_phonebooks_async_callback, stuff, _dbus_glib_async_data_free, G_TYPE_INVALID);
}
static
#ifdef G_HAVE_INLINE
inline
#endif
gboolean
org_freesmartphone_GSM_SIM_get_phonebook_info (DBusGProxy *proxy, const char * IN_category, GHashTable** OUT_info, GError **error)

{
  return dbus_g_proxy_call (proxy, "GetPhonebookInfo", error, G_TYPE_STRING, IN_category, G_TYPE_INVALID, dbus_g_type_get_map ("GHashTable", G_TYPE_STRING, G_TYPE_VALUE), OUT_info, G_TYPE_INVALID);
}
...
#endif
DBusGProxyCall*
org_freesmartphone_GSM_SIM_get_phonebook_info_async (DBusGProxy *proxy, const char * IN_category, org_freesmartphone_GSM_SIM_get_phonebook_info_reply callback, gpointer userdata)

{
  ...
  stuff->cb = G_CALLBACK (callback);
  stuff->userdata = userdata;
  return dbus_g_proxy_begin_call (proxy, "GetPhonebookInfo", org_freesmartphone_GSM_SIM_get_phonebook_info_async_callback, stuff, _dbus_glib_async_data_free, G_TYPE_STRING, IN_category, G_TYPE_INVALID);
}
static
#ifdef G_HAVE_INLINE
inline
#endif
gboolean
org_freesmartphone_GSM_SIM_retrieve_phonebook (DBusGProxy *proxy, const char * IN_category, GPtrArray** OUT_entries, GError **error)

{
  return dbus_g_proxy_call (proxy, "RetrievePhonebook", error, G_TYPE_STRING, IN_category, G_TYPE_INVALID, dbus_g_type_get_collection ("GPtrArray", dbus_g_type_get_struct ("GValueArray", G_TYPE_INT, G_TYPE_STRING, G_TYPE_STRING, G_TYPE_INVALID)), OUT_entries, G_TYPE_INVALID);
}
...
#endif
DBusGProxyCall*
org_freesmartphone_GSM_SIM_retrieve_phonebook_async (DBusGProxy *proxy, const char * IN_category, org_freesmartphone_GSM_SIM_retrieve_phonebook_reply callback, gpointer userdata)

{
  ...
  stuff->cb = G_CALLBACK (callback);
  stuff->userdata = userdata;
  return dbus_g_proxy_begin_call (proxy, "RetrievePhonebook", org_freesmartphone_GSM_SIM_retrieve_phonebook_async_callback, stuff, _dbus_glib_async_data_free, G_TYPE_STRING, IN_category, G_TYPE_INVALID);
}
static
#ifdef G_HAVE_INLINE
inline
#endif
gboolean
org_freesmartphone_GSM_SIM_delete_entry (DBusGProxy *proxy, const char * IN_category, const gint IN_index, GError **error)

{
  return dbus_g_proxy_call (proxy, "DeleteEntry", error, G_TYPE_STRING, IN_category, G_TYPE_INT, IN_index, G_TYPE_INVALID, G_TYPE_INVALID);
}
...
#endif
DBusGProxyCall*
org_freesmartphone_GSM_SIM_delete_entry_async (DBusGProxy *proxy, const char * IN_category, const gint IN_index, org_freesmartphone_GSM_SIM_delete_entry_reply callback, gpointer userdata)

{
  ...
  stuff->cb = G_CALLBACK (callback);
  stuff->userdata = userdata;
  return dbus_g_proxy_begin_call (proxy, "DeleteEntry", org_freesmartphone_GSM_SIM_delete_entry_async_callback, stuff, _dbus_glib_async_data_free, G_TYPE_STRING, IN_category, G_TYPE_INT, IN_index, G_TYPE_INVALID);
}
static
#ifdef G_HAVE_INLINE
inline
#endif
gboolean
org_freesmartphone_GSM_SIM_store_entry (DBusGProxy *proxy, const char * IN_category, const gint IN_index, const char * IN_name, const char * IN_number, GError **error)

{
  return dbus_g_proxy_call (proxy, "StoreEntry", error, G_TYPE_STRING, IN_category, G_TYPE_INT, IN_index, G_TYPE_STRING, IN_name, G_TYPE_STRING, IN_number, G_TYPE_INVALID, G_TYPE_INVALID);
}
...
#endif
DBusGProxyCall*
org_freesmartphone_GSM_SIM_store_entry_async (DBusGProxy *proxy, const char * IN_category, const gint IN_index, const char * IN_name, const char * IN_number, org_freesmartphone_GSM_SIM_store_entry_reply callback, gpointer userdata)

{
  ...
  stuff->cb = G_CALLBACK (callback);
  stuff->userdata = userdata;
  return dbus_g_proxy_begin_call (proxy, "StoreEntry", org_freesmartphone_GSM_SIM_store_entry_async_callback, stuff, _dbus_glib_async_data_free, G_TYPE_STRING, IN_category, G_TYPE_INT, IN_index, G_TYPE_STRING, IN_name, G_TYPE_STRING, IN_number, G_TYPE_INVALID);
}
static
#ifdef G_HAVE_INLINE
inline
#endif
gboolean
org_freesmartphone_GSM_SIM_retrieve_entry (DBusGProxy *proxy, const char * IN_category, const gint IN_index, char ** OUT_name, char ** OUT_number, GError **error)

{
  return dbus_g_proxy_call (proxy, "RetrieveEntry", error, G_TYPE_STRING, IN_category, G_TYPE_INT, IN_index, G_TYPE_INVALID, G_TYPE_STRING, OUT_name, G_TYPE_STRING, OUT_number, G_TYPE_INVALID);
}
...
#endif
DBusGProxyCall*
org_freesmartphone_GSM_SIM_retrieve_entry_async (DBusGProxy *proxy, const char * IN_category, const gint IN_index, org_freesmartphone_GSM_SIM_retrieve_entry_reply callback, gpointer userdata)

{
  ...
  stuff->cb = G_CALLBACK (callback);
  stuff->userdata = userdata;
  return dbus_g_proxy_begin_call (proxy, "RetrieveEntry", org_freesmartphone_GSM_SIM_retrieve_entry_async_callback, stuff, _dbus_glib_async_data_free, G_TYPE_STRING, IN_category, G_TYPE_INT, IN_index, G_TYPE_INVALID);
}
static
#ifdef G_HAVE_INLINE
inline
...

{
  ...
  stuff->cb = G_CALLBACK (callback);
  stuff->userdata = userdata;
  return dbus_g_proxy_begin_call (proxy, "GetMessagebookInfo", org_freesmartphone_GSM_SIM_get_messagebook_info_async_callback, stuff, _dbus_glib_async_data_free, G_TYPE_INVALID);
}
static
#ifdef G_HAVE_INLINE
inline
...
{
  return dbus_g_proxy_call (proxy, "RetrieveMessagebook", error, G_TYPE_STRING, IN_category, G_TYPE_INVALID, dbus_g_type_get_collection ("GPtrArray", dbus_g_type_get_struct ("GValueArray", G_TYPE_INT, G_TYPE_STRING, G_TYPE_STRING, G_TYPE_STRING, dbus_g_type_get_map ("GHashTable", G_TYPE_STRING, G_TYPE_VALUE), G_TYPE_INVALID)), OUT_messages, G_TYPE_INVALID);
}
...
org_freesmartphone_GSM_SIM_retrieve_messagebook_async_callback (DBusGProxy *proxy, DBusGProxyCall *call, void *user_data)
{
  ...
  dbus_g_proxy_end_call (proxy, call, &error, dbus_g_type_get_collection ("GPtrArray", dbus_g_type_get_struct ("GValueArray", G_TYPE_INT, G_TYPE_STRING, G_TYPE_STRING, G_TYPE_STRING, dbus_g_type_get_map ("GHashTable", G_TYPE_STRING, G_TYPE_VALUE), G_TYPE_INVALID)), &OUT_messages, G_TYPE_INVALID);
...

{
  ...
  stuff->cb = G_CALLBACK (callback);
  stuff->userdata = userdata;
  return dbus_g_proxy_begin_call (proxy, "RetrieveMessagebook", org_freesmartphone_GSM_SIM_retrieve_messagebook_async_callback, stuff, _dbus_glib_async_data_free, G_TYPE_STRING, IN_category, G_TYPE_INVALID);
}
static
#ifdef G_HAVE_INLINE
inline
...

{
  ...
  stuff->cb = G_CALLBACK (callback);
  stuff->userdata = userdata;
  return dbus_g_proxy_begin_call (proxy, "GetServiceCenterNumber", org_freesmartphone_GSM_SIM_get_service_center_number_async_callback, stuff, _dbus_glib_async_data_free, G_TYPE_INVALID);
}
static
#ifdef G_HAVE_INLINE
inline
...

{
  ...
  stuff->cb = G_CALLBACK (callback);
  stuff->userdata = userdata;
  return dbus_g_proxy_begin_call (proxy, "SetServiceCenterNumber", org_freesmartphone_GSM_SIM_set_service_center_number_async_callback, stuff, _dbus_glib_async_data_free, G_TYPE_STRING, IN_number, G_TYPE_INVALID);
}
static
#ifdef G_HAVE_INLINE
inline
...

{
  ...
  stuff->cb = G_CALLBACK (callback);
  stuff->userdata = userdata;
  return dbus_g_proxy_begin_call (proxy, "DeleteMessage", org_freesmartphone_GSM_SIM_delete_message_async_callback, stuff, _dbus_glib_async_data_free, G_TYPE_INT, IN_index, G_TYPE_INVALID);
}
static
#ifdef G_HAVE_INLINE
inline
#endif
gboolean
org_freesmartphone_GSM_SIM_store_message (DBusGProxy *proxy, const char * IN_recipient_number, const char * IN_contents, const GHashTable* IN_properties, gint* OUT_index, GError **error)

{
  return dbus_g_proxy_call (proxy, "StoreMessage", error, G_TYPE_STRING, IN_recipient_number, G_TYPE_STRING, IN_contents, dbus_g_type_get_map ("GHashTable", G_TYPE_STRING, G_TYPE_VALUE), IN_properties, G_TYPE_INVALID, G_TYPE_INT, OUT_index, G_TYPE_INVALID);
}
...
#endif
DBusGProxyCall*
org_freesmartphone_GSM_SIM_store_message_async (DBusGProxy *proxy, const char * IN_recipient_number, const char * IN_contents, const GHashTable* IN_properties, org_freesmartphone_GSM_SIM_store_message_reply callback, gpointer userdata)

{
  ...
  stuff->cb = G_CALLBACK (callback);
  stuff->userdata = userdata;
  return dbus_g_proxy_begin_call (proxy, "StoreMessage", org_freesmartphone_GSM_SIM_store_message_async_callback, stuff, _dbus_glib_async_data_free, G_TYPE_STRING, IN_recipient_number, G_TYPE_STRING, IN_contents, dbus_g_type_get_map ("GHashTable", G_TYPE_STRING, G_TYPE_VALUE), IN_properties, G_TYPE_INVALID);
}
static
#ifdef G_HAVE_INLINE
inline
...

{
  ...
  stuff->cb = G_CALLBACK (callback);
  stuff->userdata = userdata;
  return dbus_g_proxy_begin_call (proxy, "SendStoredMessage", org_freesmartphone_GSM_SIM_send_stored_message_async_callback, stuff, _dbus_glib_async_data_free, G_TYPE_INT, IN_index, G_TYPE_INVALID);
}
static
#ifdef G_HAVE_INLINE
inline
#endif
gboolean
org_freesmartphone_GSM_SIM_retrieve_message (DBusGProxy *proxy, const gint IN_index, char ** OUT_status, char ** OUT_sender_number, char ** OUT_contents, GHashTable** OUT_properties, GError **error)

{
  return dbus_g_proxy_call (proxy, "RetrieveMessage", error, G_TYPE_INT, IN_index, G_TYPE_INVALID, G_TYPE_STRING, OUT_status, G_TYPE_STRING, OUT_sender_number, G_TYPE_STRING, OUT_contents, dbus_g_type_get_map ("GHashTable", G_TYPE_STRING, G_TYPE_VALUE), OUT_properties, G_TYPE_INVALID);
}

typedef void (*org_freesmartphone_GSM_SIM_retrieve_message_reply) (DBusGProxy *proxy, char * OUT_status, char * OUT_sender_number, char * OUT_contents, GHashTable *OUT_properties, GError *error, gpointer userdata);
...
org_freesmartphone_GSM_SIM_retrieve_message_async_callback (DBusGProxy *proxy, DBusGProxyCall *call, void *user_data)
{
  ...
  dbus_g_proxy_end_call (proxy, call, &error, G_TYPE_STRING, &OUT_status, G_TYPE_STRING, &OUT_sender_number, G_TYPE_STRING, &OUT_contents, dbus_g_type_get_map ("GHashTable", G_TYPE_STRING, G_TYPE_VALUE), &OUT_properties, G_TYPE_INVALID);
  (*(org_freesmartphone_GSM_SIM_retrieve_message_reply)data->cb) (proxy, OUT_status, OUT_sender_number, OUT_contents, OUT_properties, error, data->userdata);
  return;
}
...

{
  ...
  stuff->cb = G_CALLBACK (callback);
  stuff->userdata = userdata;
  return dbus_g_proxy_begin_call (proxy, "RetrieveMessage", org_freesmartphone_GSM_SIM_retrieve_message_async_callback, stuff, _dbus_glib_async_data_free, G_TYPE_INT, IN_index, G_TYPE_INVALID);
}
