...

{
  ...
  return dbus_g_proxy_begin_call (proxy, "Register", org_freesmartphone_GSM_Network_register_async_callback, stuff, _dbus_glib_async_data_free, G_TYPE_INVALID);
}
static
#ifdef G_HAVE_INLINE
inline
...

{
  ...
  stuff->cb = G_CALLBACK (callback);
  stuff->userdata = userdata;
  return dbus_g_proxy_begin_call (proxy, "Unregister", org_freesmartphone_GSM_Network_unregister_async_callback, stuff, _dbus_glib_async_data_free, G_TYPE_INVALID);
}
static
#ifdef G_HAVE_INLINE
inline
...

{
  ...
  stuff->cb = G_CALLBACK (callback);
  stuff->userdata = userdata;
  return dbus_g_proxy_begin_call (proxy, "GetStatus", org_freesmartphone_GSM_Network_get_status_async_callback, stuff, _dbus_glib_async_data_free, G_TYPE_INVALID);
}
static
#ifdef G_HAVE_INLINE
inline
...

{
  ...
  stuff->cb = G_CALLBACK (callback);
  stuff->userdata = userdata;
  return dbus_g_proxy_begin_call (proxy, "GetSignalStrength", org_freesmartphone_GSM_Network_get_signal_strength_async_callback, stuff, _dbus_glib_async_data_free, G_TYPE_INVALID);
}
static
#ifdef G_HAVE_INLINE
inline
...

{
  ...
  stuff->cb = G_CALLBACK (callback);
  stuff->userdata = userdata;
  return dbus_g_proxy_begin_call (proxy, "ListProviders", org_freesmartphone_GSM_Network_list_providers_async_callback, stuff, _dbus_glib_async_data_free, G_TYPE_INVALID);
}
static
#ifdef G_HAVE_INLINE
inline
...

{
  ...
  stuff->cb = G_CALLBACK (callback);
  stuff->userdata = userdata;
  return dbus_g_proxy_begin_call (proxy, "RegisterWithProvider", org_freesmartphone_GSM_Network_register_with_provider_async_callback, stuff, _dbus_glib_async_data_free, G_TYPE_INT, IN_operator_code, G_TYPE_INVALID);
}
static
#ifdef G_HAVE_INLINE
inline
#endif
gboolean
org_freesmartphone_GSM_Network_get_network_country_code (DBusGProxy *proxy, char ** OUT_dial_code, char ** OUT_country_name, GError **error)

{
  return dbus_g_proxy_call (proxy, "GetNetworkCountryCode", error, G_TYPE_INVALID, G_TYPE_STRING, OUT_dial_code, G_TYPE_STRING, OUT_country_name, G_TYPE_INVALID);
}

typedef void (*org_freesmartphone_GSM_Network_get_network_country_code_reply) (DBusGProxy *proxy, char * OUT_dial_code, char * OUT_country_name, GError *error, gpointer userdata);

static void
org_freesmartphone_GSM_Network_get_network_country_code_async_callback (DBusGProxy *proxy, DBusGProxyCall *call, void *user_data)
{
  DBusGAsyncData *data = (DBusGAsyncData*) user_data;
  GError *error = NULL;
  char * OUT_dial_code;
  char * OUT_country_name;
  dbus_g_proxy_end_call (proxy, call, &error, G_TYPE_STRING, &OUT_dial_code, G_TYPE_STRING, &OUT_country_name, G_TYPE_INVALID);
  (*(org_freesmartphone_GSM_Network_get_network_country_code_reply)data->cb) (proxy, OUT_dial_code, OUT_country_name, error, data->userdata);
  return;
}
...
#endif
DBusGProxyCall*
org_freesmartphone_GSM_Network_get_network_country_code_async (DBusGProxy *proxy, org_freesmartphone_GSM_Network_get_network_country_code_reply callback, gpointer userdata)

{
  ...
  stuff->cb = G_CALLBACK (callback);
  stuff->userdata = userdata;
  return dbus_g_proxy_begin_call (proxy, "GetNetworkCountryCode", org_freesmartphone_GSM_Network_get_network_country_code_async_callback, stuff, _dbus_glib_async_data_free, G_TYPE_INVALID);
}
static
#ifdef G_HAVE_INLINE
inline
#endif
gboolean
org_freesmartphone_GSM_Network_get_call_forwarding (DBusGProxy *proxy, const char * IN_reason, GHashTable** OUT_status, GError **error)

{
  return dbus_g_proxy_call (proxy, "GetCallForwarding", error, G_TYPE_STRING, IN_reason, G_TYPE_INVALID, dbus_g_type_get_map ("GHashTable", G_TYPE_STRING, G_TYPE_VALUE), OUT_status, G_TYPE_INVALID);
}
...
#endif
DBusGProxyCall*
org_freesmartphone_GSM_Network_get_call_forwarding_async (DBusGProxy *proxy, const char * IN_reason, org_freesmartphone_GSM_Network_get_call_forwarding_reply callback, gpointer userdata)

{
  ...
  stuff->cb = G_CALLBACK (callback);
  stuff->userdata = userdata;
  return dbus_g_proxy_begin_call (proxy, "GetCallForwarding", org_freesmartphone_GSM_Network_get_call_forwarding_async_callback, stuff, _dbus_glib_async_data_free, G_TYPE_STRING, IN_reason, G_TYPE_INVALID);
}
static
#ifdef G_HAVE_INLINE
inline
...

{
  ...
  stuff->cb = G_CALLBACK (callback);
  stuff->userdata = userdata;
  return dbus_g_proxy_begin_call (proxy, "EnableCallForwarding", org_freesmartphone_GSM_Network_enable_call_forwarding_async_callback, stuff, _dbus_glib_async_data_free, G_TYPE_STRING, IN_reason, G_TYPE_STRING, IN_class, G_TYPE_STRING, IN_number, G_TYPE_INT, IN_timeout, G_TYPE_INVALID);
}
static
#ifdef G_HAVE_INLINE
inline
...

{
  ...
  stuff->cb = G_CALLBACK (callback);
  stuff->userdata = userdata;
  return dbus_g_proxy_begin_call (proxy, "DisableCallForwarding", org_freesmartphone_GSM_Network_disable_call_forwarding_async_callback, stuff, _dbus_glib_async_data_free, G_TYPE_STRING, IN_reason, G_TYPE_STRING, IN_class, G_TYPE_INVALID);
}
static
#ifdef G_HAVE_INLINE
inline
...

{
  ...
  stuff->cb = G_CALLBACK (callback);
  stuff->userdata = userdata;
  return dbus_g_proxy_begin_call (proxy, "SetCallingIdentification", org_freesmartphone_GSM_Network_set_calling_identification_async_callback, stuff, _dbus_glib_async_data_free, G_TYPE_STRING, IN_visible, G_TYPE_INVALID);
}
static
#ifdef G_HAVE_INLINE
inline
...

{
  ...
  stuff->cb = G_CALLBACK (callback);
  stuff->userdata = userdata;
  return dbus_g_proxy_begin_call (proxy, "GetCallingIdentification", org_freesmartphone_GSM_Network_get_calling_identification_async_callback, stuff, _dbus_glib_async_data_free, G_TYPE_INVALID);
}
static
#ifdef G_HAVE_INLINE
inline
#endif
gboolean
org_freesmartphone_GSM_Network_send_ussd_request (DBusGProxy *proxy, const char * IN_request, GError **error)

{
  return dbus_g_proxy_call (proxy, "SendUssdRequest", error, G_TYPE_STRING, IN_request, G_TYPE_INVALID, G_TYPE_INVALID);
}

typedef void (*org_freesmartphone_GSM_Network_send_ussd_request_reply) (DBusGProxy *proxy, GError *error, gpointer userdata);

static void
org_freesmartphone_GSM_Network_send_ussd_request_async_callback (DBusGProxy *proxy, DBusGProxyCall *call, void *user_data)
{
  DBusGAsyncData *data = (DBusGAsyncData*) user_data;
  GError *error = NULL;
  dbus_g_proxy_end_call (proxy, call, &error, G_TYPE_INVALID);
  (*(org_freesmartphone_GSM_Network_send_ussd_request_reply)data->cb) (proxy, error, data->userdata);
  return;
}
...
#endif
DBusGProxyCall*
org_freesmartphone_GSM_Network_send_ussd_request_async (DBusGProxy *proxy, const char * IN_request, org_freesmartphone_GSM_Network_send_ussd_request_reply callback, gpointer userdata)

{
  ...
  stuff->cb = G_CALLBACK (callback);
  stuff->userdata = userdata;
  return dbus_g_proxy_begin_call (proxy, "SendUssdRequest", org_freesmartphone_GSM_Network_send_ussd_request_async_callback, stuff, _dbus_glib_async_data_free, G_TYPE_STRING, IN_request, G_TYPE_INVALID);
}
