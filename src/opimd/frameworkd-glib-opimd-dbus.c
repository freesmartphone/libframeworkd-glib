...
DBusGProxy *dbus_connect_to_opimd_contact_query(const char *query_path) {
	 return (dbus_connect_to_interface (OPIMD_BUS, query_path, CONTACT_QUERY_INTERFACE, "PIM Contact Query"));
}
...
DBusGProxy *dbus_connect_to_opimd_message_query(const char *query_path) {
	 return (dbus_connect_to_interface (OPIMD_BUS, query_path, MESSAGE_QUERY_INTERFACE, "PIM Message Query"));
}

DBusGProxy *dbus_connect_to_opimd_message_folder(const char *folder_path) {
	 return (dbus_connect_to_interface (OPIMD_BUS, folder_path, MESSAGE_FOLDER_INTERFACE, "PIM Message Folder"));
}
